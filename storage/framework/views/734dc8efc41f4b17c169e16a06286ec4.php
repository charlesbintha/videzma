...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('assets/images/logo/videzma-icon.png')); ?>" type="image/png">
    <style>
        body {
...
<body>
    <div class="wrap">
        <div class="logo">
            <img src="<?php echo e(asset('assets/images/logo/videzma.png')); ?>" alt="Videzma">
        </div>
        <div class="card">
            ...
            <a href="<?php echo e(route('login')); ?>" class="btn">Acceder a l'administration</a>
            <div class="features">
                <div class="feature">
...
<?php /**PATH /home/u528935801/domains/emmaluxury.store/public_html/videzma/resources/views/welcome.blade.php ENDPATH**/ ?>